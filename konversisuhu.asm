...
;; VARIABEL OF DATA
MSG1		DB 'TEMPERATUR CONVERTER', 13, 10, '$'
MSG_IN		DB 'CHOOSE AN OPTION : $'
MSG_OPT1	DB '1. CELCIUS TO KELVIN', 13, 10, '$'
MSG_OPT2	DB '2. CELCIUS TO FAHRENHEIT', 13, 10, '$'
MSG_OPT3	DB '3. FAHRENHEIT TO KELVIN', 13, 10, '$'
MSG_OPT4	DB '4. FAHRENHEIT TO CELCIUS', 13, 10, '$'
MSG_OPT5	DB '5. KELVIN TO FAHRENHEIT', 13, 10, '$'
MSG_OPT6	DB '6. KELVIN TO CELCIUS', 13, 10, '$'
MSG_IN2		DB 13, 10, 'INPUT TEMPERATURE : $'
DEGREE		DB 248, '$'
MSG_ERROR	DB 13, 10, 'INPUT ERROR!', 13, 10, '$'
MSG_OUT		DB 13, 10, 'RESULT = $'
STOR		DW 0	; MEMORY
MSG_EXIT	DB 13, 10, 'PRESS', 13, 10,' [0] RETURN', 13, 10
...
; GENERATE SOUND
	SOUNDER:
		...
		OUT 	43H, AL		;SEND
		MOV	AX, STOR	;MASUKKAN FREKUENSI KE AX
		OUT	42H, AL		;SEND LSB
...
SET_MINUS:
	MOV CS:MAKE_MINUS, 1 ;CHECK FLAG
	JMP NEXTDIGIT
BIG2:
	MOV CX, DX
	MOV DX, 0
